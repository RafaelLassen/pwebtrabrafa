  ...
  <div style="padding: 10px 40px">
    <div>
      ...
      <form action="CarroList.php" method="post" class="form-inline" style="gap: 10px; padding: 10px 0 ">
        ...
        <a href="CarroForm.php" class="btn btn-danger"> Cadastrar </a>
      </form>
    </div>
    ...
    <table class="table" class="container">
      ...
      <tbody>
        ...
        foreach ($dados as $item) {
          ...
          echo "<td>$item->ano</td>";
          echo "<td><a href='CarroForm.php?id=$item->id'> <i class='fa-regular fa-pen-to-square'></i>Editar</a></td>";
          echo "<td><a onclick='return confirm(\"Deseja Excluir?\")'
                    href='CarroList.php?id=$item->id' >Deletar</a>
                  </td>";
          echo "</tr>";
        }
        ?>
